...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
      ...
      //  mImageLayer.contents = (id)[UIImage imageNamed:@"2.png"].CGImage;
        ...
        mImageLayer.borderColor = [UIColor blackColor].CGColor;
...
-(void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    mImageLayer.borderColor = selected ? [UIColor colorWithRed:(174/255.0) green:(37/255.0) blue:(30/255.0) alpha:1.0].CGColor : [UIColor blackColor].CGColor;
    mCellTtleLabel.textColor = selected ? [UIColor colorWithRed:(174/255.0) green:(37/255.0) blue:(30/255.0) alpha:1.0] : [UIColor blackColor];
}
