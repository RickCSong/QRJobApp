...
<meta content="68ZTOi1OX4tYgSOW4AUNkre7DaC1QCM8+vNYmg5ubUI=" name="csrf-token" />
  ...
  <input type="text" name="q" id="command-bar" placeholder="Search or type a command" tabindex="1" data-username="RickCSong" autocapitalize="off">
  ...
  <ul class="top-nav">
    ...
    <ul id="user-links">
      <li>
        <a href="https://github.com/RickCSong" class="name">
          <img height="20" src="https://secure.gravatar.com/avatar/4321f706d8eca4978ea06385b5f0e0db?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /> RickCSong
        </a>
      </li>
      <li>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="68ZTOi1OX4tYgSOW4AUNkre7DaC1QCM8+vNYmg5ubUI=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="1580893" />
    ...
    <li class="js-toggler-container js-social-container starring-container ">
      ...
      <a class="social-count js-social-count" href="/jeromeetienne/jquery-qrcode/stargazers">703</a>
    </li>

        <li>
          <a href="/jeromeetienne/jquery-qrcode/fork_select" class="minibutton js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="facebox nofollow">
            <span class="mini-icon mini-icon-branch-create"></span>
            <span class="text">Fork</span>
          </a>
          <a href="/jeromeetienne/jquery-qrcode/network" class="social-count">161</a>
        </li>
  ...
  <ul class="tabs">
    <li><a href="/jeromeetienne/jquery-qrcode" class="selected" highlight="[:repo_source, :repo_downloads, :repo_commits, :repo_tags, :repo_branches]">Code</a></li>
    <li><a href="/jeromeetienne/jquery-qrcode/network" highlight="[:repo_network]">Network</a></li>
    <li><a href="/jeromeetienne/jquery-qrcode/pulls" highlight="[:repo_pulls]">Pull Requests <span class='counter'>10</span></a></li>

      <li><a href="/jeromeetienne/jquery-qrcode/issues" highlight="[:repo_issues]">Issues <span class='counter'>20</span></a></li>

      <li><a href="/jeromeetienne/jquery-qrcode/wiki" highlight="[:repo_wiki]">Wiki</a></li>


    <li><a href="/jeromeetienne/jquery-qrcode/graphs" highlight="[:repo_graphs, :repo_contributors]">Graphs</a></li>
      ...
      <div class="select-menu-modal-holder js-menu-content js-navigation-container js-select-menu-pane">
        ...
        <div class="select-menu-modal js-select-menu-pane">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target ">
                <span class="select-menu-checkmark mini-icon mini-icon-confirm"></span>
                <a href="/jeromeetienne/jquery-qrcode/blob/gh-pages/src/qrcode.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="gh-pages" rel="nofollow" title="gh-pages">gh-pages</a>
              </div> <!-- /.select-menu-item -->

              <div class="select-menu-item js-navigation-item js-navigation-target selected">
                <span class="select-menu-checkmark mini-icon mini-icon-confirm"></span>
                <a href="/jeromeetienne/jquery-qrcode/blob/master/src/qrcode.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
              </div> <!-- /.select-menu-item -->
...
<div id="slider">
    <div class="frame-meta">
      ...
      <p title="This is a placeholder element" class="js-history-link-replace hidden"></p>
        ...
        <div class="breadcrumb">
          <span class='bold'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jeromeetienne/jquery-qrcode" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">jquery-qrcode</span></a></span></span> / <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/jeromeetienne/jquery-qrcode/tree/master/src" class="js-slide-to" data-direction="back" itemscope="url"><span itemprop="title">src</span></a></span> / <strong class="final-path">qrcode.js</strong> <span class="js-zeroclipboard zeroclipboard-button" data-clipboard-text="src/qrcode.js" data-copied-hint="copied!" title="copy to clipboard"><span class="mini-icon mini-icon-clipboard"></span></span>
        </div>
  ...
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/caff05c5673aa3b95ad24d008e7e82fa?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
    <span class="author"><span rel="author">Khalid Yagoubi</span></span>
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/jeromeetienne/jquery-qrcode/blob/2d05056217d5b46e2dbadde1ea8a1ca3cd2b6ad8/src/qrcode.js" data-title="jquery-qrcode/src/qrcode.js at master · jeromeetienne/jquery-qrcode · GitHub" data-type="blob">
              ...
              <div class="actions">
                <div class="button-group">
                        <a class="minibutton tooltipped leftwards"
                           ...
                           href="/jeromeetienne/jquery-qrcode/edit/master/src/qrcode.js"
                           data-method="post" rel="nofollow">Edit</a>
                  <a href="/jeromeetienne/jquery-qrcode/raw/master/src/qrcode.js" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/jeromeetienne/jquery-qrcode/blame/master/src/qrcode.js" class="button minibutton ">Blame</a>
                  <a href="/jeromeetienne/jquery-qrcode/commits/master/src/qrcode.js" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.06560s from fe2.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
      ...
      <textarea name="fullscreen-contents" id="fullscreen-contents" class="js-fullscreen-contents" placeholder="" data-suggester="fullscreen_suggester"></textarea>
          <div class="suggester-container">
              <div class="suggester fullscreen-suggester js-navigation-container" id="fullscreen_suggester"
                 data-url="/jeromeetienne/jquery-qrcode/suggestions/commit/2d05056217d5b46e2dbadde1ea8a1ca3cd2b6ad8">
              </div>
          </div>
    </div>
  </div>
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.06616' data-host='fe2'></span>
